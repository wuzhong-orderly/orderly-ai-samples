...
export function getEvmInitialConfig() {
  if (getRuntimeConfigBoolean("VITE_DISABLE_EVM_WALLETS")) {
    return undefined;
  }
  ...
  return {
    options: {
      wallets,
      appMetadata: {
        name: getRuntimeConfig("VITE_ORDERLY_BROKER_NAME") || "DEX",
...
export function getSolanaWallets(networkId: NetworkId) {
  if (getRuntimeConfigBoolean("VITE_DISABLE_SOLANA_WALLETS")) {
    return [];
  }
